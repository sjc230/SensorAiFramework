...
file_name = "smartplug_feature_4k.npy"
...
#c1_data = np.load("/content/drive/MyDrive/Colab Notebooks/SmartPlug_IM-Case_Data/smartplug_c1_new.npy",allow_pickle=True)
#c2_data = np.load("/content/drive/MyDrive/Colab Notebooks/SmartPlug_IM-Case_Data/smartplug_c2_new.npy",allow_pickle=True)
#c3_data = np.load("/content/drive/MyDrive/Colab Notebooks/SmartPlug_IM-Case_Data/smartplug_c3_new.npy",allow_pickle=True)
#pcc_data = np.load("/content/drive/MyDrive/Colab Notebooks/SmartPlug_IM-Case_Data/smartplug_pcc_new.npy",allow_pickle=True)
pcc_data = np.load(p / file_name,allow_pickle=True)
...
def generateMessage(mac_address,num_data,timestamp,time_interval,data):
  ...
  if isinstance(data, int):
    ...
    data_bytes = str(temp)
    bdata_bytes = bytes(data_bytes,'utf-8')
  else:
